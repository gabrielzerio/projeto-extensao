...
const pieces = [
  { type: "rook", color: "black", position: { row: 0, col: 10 } },
  { type: "knight", color: "black", position: { row: 0, col: 11 } },
  { type: "bishop", color: "black", position: { row: 0, col: 12 } },
  { type: "queen", color: "black", position: { row: 0, col: 13 } },
  { type: "king", color: "black", position: { row: 0, col: 14 } },
  { type: "bishop", color: "black", position: { row: 0, col: 15 } },
  { type: "knight", color: "black", position: { row: 0, col: 16 } },
  { type: "rook", color: "black", position: { row: 0, col: 17 } },
  ...Array(8).fill(null).map((_, i) => ({ type: "pawn", color: "black", position: { row: 1, col: 12 }, })),
  ...Array(8).fill(null).map((_, i) => ({ type: "pawn", color: "white", position: { row: 6, col: i }, })),
  { type: "rook", color: "white", position: { row: 7, col: 10 } },
  { type: "knight", color: "white", position: { row: 7, col: 11 } },
  { type: "bishop", color: "white", position: { row: 7, col: 12 } },
  { type: "queen", color: "white", position: { row: 7, col: 13 } },
  { type: "king", color: "white", position: { row: 7, col: 14 } },
  { type: "bishop", color: "white", position: { row: 7, col: 15 } },
  { type: "knight", color: "white", position: { row: 7, col: 16 } },
  { type: "rook", color: "white", position: { row: 7, col: 17 } },
];
